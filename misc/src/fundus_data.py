...
def drive_train(reshape=True):
    ...
    raw = D.images('/home/gaby/These/Data/Fundus/Vessels/DRIVE/train/0-images/', 'raw', **kwargs)
    av = D.images('/home/gaby/These/Data/Fundus/Vessels/DRIVE/train/2-label_AV/', 'av', **kwargs)
    return D.join(raw, av)

def drive_test(reshape=True):
    kwargs = dict(reshape=565, keep_proportion='crop') if reshape else {}
    raw = D.images('/home/gaby/These/Data/Fundus/Vessels/DRIVE/test/original/0-images/', 'raw', **kwargs)
    av = D.images('/home/gaby/These/Data/Fundus/Vessels/DRIVE/test/original/2-label_AV/', 'av', **kwargs)
    ct = D.images('/home/gaby/These/Data/Fundus/Vessels/DRIVE/test/original/2-label_AV_CT/', 'ct', **kwargs)
    ct2px = D.images('/home/gaby/These/Data/Fundus/Vessels/DRIVE/test/original/2-label_AV_CT2px/', 'ct2px', **kwargs)
